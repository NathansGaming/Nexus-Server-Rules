...
public final class BanCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        PlayerProfile profile = Bukkit.createPlayerProfile(targetId, targetName);
        Bukkit.getBanList(BanList.Type.PROFILE).addBan(profile, reason, (Date) null, sender.getName());
