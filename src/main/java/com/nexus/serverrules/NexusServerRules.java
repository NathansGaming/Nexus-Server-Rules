...
public final class NexusServerRules extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (getConfig().getBoolean("grief-detection.enabled", true)) {
            ...
            LandTrustBridge landTrust = new LandTrustBridge(this);
            getServer().getPluginManager().registerEvents(
                    new GriefListener(this, punishmentManager, reviewQueue, windowSeconds, blockThreshold, registryCapacity, landTrust), this);
        } else {
