...
public final class DimensionPreset {
    ...
    public static final class MobProfile {
        ...
        /** Only affects mobs with an ATTACK_DAMAGE attribute (most melee hostiles); silently ignored otherwise. */
        public double damageMultiplier = 1.0;
        /**
         * Visual size multiplier via Attribute.SCALE (added in 1.20.5).
         */
